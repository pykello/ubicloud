...
# Check constraints:
#  persistent_storage_volume_check | ((vm_host_id IS NULL) = (vhost_block_backend_id IS NULL) AND (vm_host_id IS NULL) = (storage_device_id IS NULL) AND (vm_host_id IS NULL) = (key_encryption_key_id IS NULL))
# Foreign key constraints:
#  persistent_storage_volume_key_encryption_key_id_fkey  | (key_encryption_key_id) REFERENCES storage_key_encryption_key(id)
#  persistent_storage_volume_storage_device_id_fkey      | (storage_device_id) REFERENCES storage_device(id)
