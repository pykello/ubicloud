...
RSpec.describe Clover, "machine-image" do
  ...
  describe "authenticated" do
    ...
    describe "delete version" do
      ...
      # Status flip + latest_version_id reassignment + R2 wipe now run
      # asynchronously inside VersionMetalNexus; the route just queues
      ...
      it "queues destroy even on a creating version (the nexus waits for the archive child)" do
        mi_version_metal
        visit "#{project.path}/location/#{TEST_LOCATION}/machine-image/#{mi.name}/versions"
