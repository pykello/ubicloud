...
RSpec.describe Clover, "machine-image" do
  ...
  let(:project_wo_permissions) {
    p = user.create_project_with_default_policy("project-2", default_policy: nil)
    p.set_ff_machine_image(true)
    p
  }
  ...
  describe "authenticated" do
    ...
    describe "create" do
      ...
      it "can not create machine image when does not have permissions" do
