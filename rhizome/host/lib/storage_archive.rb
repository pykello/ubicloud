...
class StorageArchive
  def initialize(disk_config_path, disk_kek_path, disk_kek, target_conf, vhost_block_backend_version)
    ...
    StorageArchive.verify_key_encryption_algorithm(disk_kek, "disk_kek") if disk_kek
    StorageArchive.verify_key_encryption_algorithm(target_conf["archive_kek"], "target_conf archive_kek")
  ...
  def self.verify_key_encryption_algorithm(kek, context)
