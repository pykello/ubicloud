...
RSpec.describe StorageVolume do
  ...
  describe "#vhost_backend_start" do
    it "can start an encrypted vhost backend" do
      ...
      expect(KekPipe).to receive(:with_kek_pipe).with(kek_pipe, owner: "test").and_yield(kek_pipe)
      expect(KekPipe).to receive(:write_kek_to_pipe).with(kek_pipe, /aes256-gcm/)
